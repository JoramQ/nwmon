...
> **Note**: Entity IDs are auto-generated by Home Assistant based on device name. Check **Settings → Devices & Services → Entities** for the actual entity ID of your device.
